...
You can install the development version of coreR from [GitHub](https://github.com/) with:
...
* These can be accessed using `system.file('sections', '<filename>', package = 'coreR')` and then copied into a local file structure.
